# Conseils généraux pour la conception des {prompts/instructions/messages de commande} TODO

Voici quelques conseils à garder à l'esprit lorsque vous concevez vos {prompts/instructions/messages de commande} TODO :


### Commencez simplement
Lorsque vous commencez à concevoir des {prompts/instructions/messages de commande} TODO, vous devez garder à l'esprit qu'il s'agit d'un processus itératif qui nécessite de nombreuses expérimentations pour obtenir des résultats optimaux. L'utilisation d'un terrain de jeu simple comme OpenAI ou Cohere est un bon point de départ.


Vous pouvez commencer par des {prompts/instructions/messages de commande} TODO simples et ajouter des éléments et des contextes au fur et à mesure que vous cherchez à obtenir de meilleurs résultats. Pour cette raison, il est essentiel de modifier votre {prompt/instruction/message de commande} TODO en cours de route. En lisant le guide, vous verrez de nombreux exemples où la spécificité, la simplicité et la concision permettent souvent d'obtenir de meilleurs résultats.

Lorsque vous avez une tâche importante qui implique de nombreuses sous-tâches différentes, vous pouvez essayer de décomposer la tâche en sous-tâches plus simples et continuer à les développer au fur et à mesure que vous obtenez de meilleurs résultats. Cela permet d'éviter d'ajouter trop de complexité au processus de conception du {prompt/instruction/message de commande} TODO au début.
