...
Cet exemple de base souligne également la nécessité de fournir d'avantage de contexte ou d'instructions sur ce que nous voulons accomplir.
...
Ceci peut-être formulé dans un format Question-Réponse (QR), qui est standard dans de nombreux ensembles de données QR, comme suit :
